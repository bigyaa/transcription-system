...
#   TRANSCRIBER_CONFIG - XML file default values
...
class XMLFile(object):
    def __init__( self, config_file=DEFAULT.TRANSCRIBER_CONFIG[CONST.CONFIG_FILE_KEY], config_schema=DEFAULT.TRANSCRIBER_CONFIG[CONST.CONFIG_SCHEMA_KEY] ):
        #
        self._contents = {}
        self.file_missing = []
        self.file_malformed = []
