...
from config.DEFAULTS import (LOG_RECORD_FORMAT_CONFIG)
...
class LogRecordFormatter(logging.Formatter):
    ...
    @staticmethod
    def line_format(): return LOG_RECORD_FORMAT_CONFIG['line_format']

    @staticmethod
    def date_format(): return LOG_RECORD_FORMAT_CONFIG['date_format']

    def __init__(self, color, *args, **kwargs):
        super(LogRecordFormatter, self).__init__(*args, **kwargs)
        self.useColor = color
        self.colorCodes = LOG_RECORD_FORMAT_CONFIG['color_codes']
        self.resetCode = LOG_RECORD_FORMAT_CONFIG['reset']
